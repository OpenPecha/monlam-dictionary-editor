        ...
        <div className=' fixed inset-0 flex items-center justify-center bg-grey-800 bg-opacity-50 z-50'>
            <div className=' bg-white border-black border-2 p-12 rounded-xl w-10/12 h-5/6'>
                ...
                <div className=' flex items-center border-b-2 border-black mt-3 pb-2 w-1/4'>
                    ...
                    <input placeholder='DD/MM/YYYY' className=' ml-11 outline-none mt-2 text-1xl'></input>
                </div>
                <div className=' flex items-center border-b-2 border-black mt-3 pb-2 w-1/4'>
                    <label className=' text-lg font-monlam w-2/4'>འདས་ལོ།</label>
                    <input placeholder='DD/MM/YYYY' className=' ml-8 outline-none mt-2 text-1xl w-96'></input>
                </div>
                <div className=' flex items-center border-b-2 border-black mt-3 pb-2 w-2/4'>
